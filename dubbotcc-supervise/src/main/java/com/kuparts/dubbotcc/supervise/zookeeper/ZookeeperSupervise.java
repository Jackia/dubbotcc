...
import com.kuparts.dubbotcc.supervise.support.NotifyCallback;
    ...
    public boolean notice(String namespace, String url) {
        ...
        client.addStateListener(new StateListener() {
            ...
            public void stateChanged(int connected) {
                System.out.println(connected + ":连接状态................");
            }
        });
        ...
        listerner();//监听
        LOG.debug("start zookeeper childeren listerner....");
        return true;
    }
